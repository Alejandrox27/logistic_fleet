...
public class VehiclesRiskDTO {
    ...
    public VehiclesRiskDTO(int id_vehicle, String number_plate, String brand, double total_spent, double risk_threshold) {
    ...
    public String toString() {
        return String.format("| %-10d | %-10s | %-10s | %-12.2f | %-12.2f |",
                id_vehicle, number_plate, brand, total_spent, risk_threshold);
    }
